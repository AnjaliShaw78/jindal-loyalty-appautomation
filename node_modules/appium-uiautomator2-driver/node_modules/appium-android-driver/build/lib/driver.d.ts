...
import { getThirdPartyPackages, uninstallOtherPackages, installOtherApks, installAUT, resetAUT, background, mobileBackgroundApp, getCurrentActivity, getCurrentPackage, mobileClearApp, mobileInstallApp, installApp, mobileIsAppInstalled, mobileRemoveApp, mobileTerminateApp, mobileListApps, terminateApp, removeApp, activateApp, queryAppState, isAppInstalled } from './commands/app-management.js';
import { mobileGetUiMode, mobileSetUiMode } from './commands/appearance.js';
import { mobileBluetooth } from './commands/bluetooth.js';
import { getContexts, getCurrentContext, defaultContextName, assignContexts, switchContext, defaultWebviewName, isWebContext, isChromedriverContext, startChromedriverProxy, onChromedriverStop, stopChromedriverProxies, suspendChromedriverProxy, startChromeSession, mobileGetContexts, mobileGetChromeCapabilities, getWindowHandle, getWindowHandles, setWindow, notifyBiDiContextChange } from './commands/context/exports.js';
import { getDeviceInfoFromCaps, createADB, getLaunchInfo, initDevice } from './commands/device/common.js';
import { fingerprint, mobileFingerprint, sendSMS, mobileSendSms, gsmCall, mobileGsmCall, gsmSignal, mobileGsmSignal, gsmVoice, mobileGsmVoice, powerAC, mobilePowerAc, powerCapacity, mobilePowerCapacity, networkSpeed, mobileNetworkSpeed, sensorSet } from './commands/device/emulator-actions.js';
...
import { getAttribute, getName, elementDisplayed, elementEnabled, elementSelected, setElementValue, doSetElementValue, replaceValue, setValueImmediate, setValue, click, getLocationInView, getText, getLocation, getSize } from './commands/element.js';
...
import { setGeoLocation, getGeoLocation, mobileRefreshGpsCache, toggleLocationServices, isLocationServicesEnabled, mobileGetGeolocation, mobileSetGeolocation, mobileResetGeolocation } from './commands/geolocation.js';
import { performActions } from './commands/gestures.js';
import { mobileInjectEmulatorCameraImage } from './commands/image-injection.js';
import { isIMEActivated, availableIMEEngines, getActiveIMEEngine, activateIMEEngine, deactivateIMEEngine, setStylusHandwriting } from './commands/ime.js';
import { mobileStartActivity, mobileBroadcast, mobileStartService, mobileStopService } from './commands/intent.js';
import { hideKeyboard, isKeyboardShown, keys, doSendKeys, pressKeyCode, longPressKeyCode, mobilePerformEditorAction } from './commands/keyboard.js';
...
import { mobileStartLogsBroadcast, mobileStopLogsBroadcast, getLogTypes, getLog, assignBiDiLogListener } from './commands/log.js';
import { mobileIsMediaProjectionRecordingRunning, mobileStartMediaProjectionRecording, mobileStopMediaProjectionRecording } from './commands/media-projection.js';
import { mobileSendTrimMemory } from './commands/memory.js';
import { getWindowRect, getWindowSize, getDisplayDensity, mobileGetNotifications, mobileListSms, openNotifications, setUrl } from './commands/misc.js';
import { getNetworkConnection, isWifiOn, mobileGetConnectivity, mobileSetConnectivity, setNetworkConnection, setWifiState, setDataState, toggleData, toggleFlightMode, toggleWiFi } from './commands/network.js';
...
declare class AndroidDriver extends BaseDriver<AndroidDriverConstraints, StringRecord> implements ExternalDriver<AndroidDriverConstraints, string, StringRecord> {
    ...
    _chromedriverCapsCache: LRUCache<string, StringRecord>;
    ...
    mobileGetChromeCapabilities: typeof mobileGetChromeCapabilities;
    ...
    mobileListApps: typeof mobileListApps;
